document.addEventListener("DOMContentLoaded", () => {
    ...
    let storedValue = localStorage.getItem("selectedRegistrosHB10");
    ...
    select.addEventListener("change", () => {
        registros = select.options[select.selectedIndex].value;
        localStorage.setItem("selectedRegistrosHB10", registros); // Guardar el valor seleccionado en localStorage
