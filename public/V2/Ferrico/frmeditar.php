...
$Fecha = $_GET['Fecha'];
$volumenInicial = $_GET['Volumen_Inicial'];
$volumenFinal = $_GET['Volumen_Final'];
$densidad = $_GET['Densidad'];
$riqueza = $_GET['Riqueza'];
$acidolibre = $_GET['AcidoLibre'];
$notas = $_GET['Notas'];
...
<head>
    ...
    <meta name="description" content="Formulario para editar fabricaciones de Férrico con PHP y HTML">    
            ...
            <fieldset class="datosp18"><legend>DATOS FABRICACIÓN <span><?php echo $NumeroFabricacion?></span></legend>            
                ...
                <p>
                    <lu>
                        ...
                        <input type="text" name="VolumenInicial" class="peso" id="VolumenInicial" value="<?php echo $volumenInicial?>">
                    </lu>
                </p>
                <P>                    
                </P>
                <p>
                    <lu>
                        <label class="editar">Volumen Final: </label>
                        <input type="text" name="VolumenFinal" class="peso" id="VolumenFinal" value="<?php echo $volumenFinal ?>">
                    </lu>
                </p>
                <p>
                    <lu>
                ...
                <p>
                    <lu>
                        ...
                        <input type="text" name="AcidoLibre" class="peso" id="AcidoLibre" value="<?php echo $acidolibre ?>">
                    </lu>
                </p>
            </fieldset>
        </div>
