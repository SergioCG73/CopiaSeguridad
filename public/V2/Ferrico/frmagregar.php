...
<head>
    ...
    <title>Agregar Férrico</title>
</head>
<body>
    <header>     
        <a href="#" class="logo">Agregar fabricación Férrico</a>            
    </header>
    ...
    <div class="main-container">
        <div class="left-container">
            <fieldset class="agregar"><legend>DATOS FABRICACIÓN</legend> 
                ...
                <p><label class="_100px">Volumen inicial: </label><input type="text" name="VolumenInicial" id="VolumenInicial" required></p>
                <p><label class="_100px">Volumen final: </label><input type="text" name="VolumenFinal" id="VolumenFinal"></p>
                ...
                <p><label class="_100px">Ácido libre: </label><input type="text" name="AcidoLibre" id="AcidoLibre"></p>
            </fieldset>
        </div>
