...
// ------------------    
    $sql = $conexion->prepare("INSERT INTO sulfacid (NumeroFabricacion, Fecha, Semana, Volumen, Densidad, Riqueza, Ph, Notas) 
                               VALUES ($NumFabricacion, '$Fecha', '$Semana', $Volumen, $Densidad, $Riqueza, $Ph, '$Notas')");
