...
<body>
    ...
    <!--<form name="Editar" id="Editar" method="post" action="Actions/ActualizarSulfato.php">-->º
            ...
            <div class="izquierda">
                <fieldset>
                    <legend>Datos fabricación</legend>        		
                        ...
                        <p><label>Reactor:</label for="txtReactor"><input type="text" id="Reactor" name="txtReactor" value="<?php echo $fila['Reactor'];?>" style="width:50px"/></lu></p>
                </fieldset>
            </div>    
            <div class="derecha">
                <fieldset>
